...
#Callbacks to set inputs. This works, as δ functions somehow get ignored if i add them manually
begin
...
#Integral of red thing should be 4x integral blue thing
begin
	s1 = sum(y1)*0.001;
	s2 = sum(y2)*0.001
...
# ╔═╡ 994d8212-5c09-4e02-9045-7786f60a61d3
begin
	fig3 = Figure()
	ax3 = Axis(fig3[1, 1])
	ln3  = lines!(ax3, xvals2, vec(solvbal[1,:, : ].+solvbal[2, :, :]) )
	ln4  = lines!(ax3, xvals2, vec(solvbal[1,:, : ].-solvbal[2, :, :]) )
	fig3
end
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "7e15e364e5e2ab4ae07fce28ab5f02aef3755332"
